...
public class Buffer {
    ...
    private int cantEltos = (int) ((Math.random() * 50) % 100) + 1;
    private int limMax = 50;
    
    public void ponerElemento(String name){
        try {
        ...
        while(!semPSalida.tryAcquire()){
            ...
            try{
                if(cantEltos != limMax){
                    ...
                    System.out.println("Producto creado (+1) por "+name+", Total = "+ cantEltos);
                }
            }
            finally{
                lockEltos.unlock();
    ...
    public void consumirElemento(String name){
        try {
        ...
        while(!semCSalida.tryAcquire()){
            ...
            try{
                if(cantEltos > 0){
                    cantEltos = cantEltos - 1;
                    System.out.println("Ñam Ñam Ñam Producto consumido (-1) por "+name+", Total = "+ cantEltos);
                }
            }
            finally{
                lockEltos.unlock();
